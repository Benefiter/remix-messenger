...
export async function setSessionActiveChannelAndId(request: Request, channelData: string[]) {
  const session = await storage.getSession(
    request.headers.get("Cookie")
  );
...
export async function setSessionActiveChannel(request: Request, channel: string) {
  const session = await storage.getSession(
    request.headers.get("Cookie")
  );
...
export async function getSessionActiveChannelAndId(request: Request) {
  const session = await getUserSession(request);
...
export async function getSessionActiveChannel(request: Request) {
  const session = await getUserSession(request);
  const activeChannel = await session.get('activeChannel')
